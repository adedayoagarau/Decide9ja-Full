...
# Trusted Nigerian news sources with updated selectors
NEWS_SOURCES = {
    "premium_times": {
        "name": "Premium Times",
    ...
    "sahara_reporters": {
        ...
        "politics_url": "https://saharareporters.com/articles/politics",
        "selectors": {
            "articles": "article, .node--type-article, .views-row",
            "title": "h2 a, h3 a, .field--name-title a",
            "link": "h2 a, h3 a, .field--name-title a",
            "excerpt": ".field--name-body p, .teaser-text",
