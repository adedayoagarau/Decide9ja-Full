...
if not ACCESS_TOKEN:
    logger.warning("⚠️ WHATSAPP_ACCESS_TOKEN not set — Meta WhatsApp API will not work")
if not PHONE_NUMBER_ID:
    logger.warning("⚠️ WHATSAPP_PHONE_NUMBER_ID not set — Meta WhatsApp API will not work")
